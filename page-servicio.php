...
get_header(); ?>
    ...
    <div class="inner-heading">
        <div class="container">
            <h3>Caracterización de Materias Primas</h3>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="about-service">
                        <li> Muestreo en Campo</li>
                        <li>Selección de terrenos para aplicaciones cerámicas industriales</li>
                        <li>Análisis químico por fluorescencia de rayos X</li>
                        <li>Análisis mineralógico por difracción de rayos X</li>
                        <li>Determinación del coeficiente de dilatación térmica</li>
                        <li>Cuantificación de sulfatos y cloruros solubles</li>
                        <li>Cuantificación de sulfatos y cloruros solubles</li>
                        <li>Análisis próximos a carbones y biomasas </li>
                        <li>Granulometría</li>
                        <li>Textura por hidrometría</li>
                        <li> Conformado de probetas por extrusión</li>
                        <li>Conformado de probetas por prensado</li>
                        <li>Conformado de probetas por colaje</li>
                        <li>Evaluación de materias primas alternativas para uso cerámico</li>
                        <li>Evaluación de subproductos industriales para uso cerámico (co-procesamiento)</li>
                        <li>Caracterización tecnológica de arcillas y pastas de producción para productos 	prensados, extruidos y colados</li>
                        <li>Caracterización de feldespatos, calizas, dolomitas, arenas y otros minerales de uso 	cerámico</li>
                        <div class="clearfix"></div>
                    </ul>
                </div>
