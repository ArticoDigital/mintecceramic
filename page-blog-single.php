    ...
    <div class="inner-content">
        <div class="container">
            ...
            <div class="blogWraper blogdetail">
                <ul class="blogList">
                    <li>
                        <div class="postimg"><img src="<?php bloginfo('template_url')?>/assets/images/blog/large-1.jpg" alt="Blog Title">
                            <div class="date"> 17 SEP</div>
                        </div>
                        <div class="post-header margin-top30">
                            <h4>Análisis de Arcillas</h4>
                            <div class="postmeta">Por : <span>Camilo Quintero </span> </div>
                        </div>
                        <p> Trabajamos como laboratorio de arcillas de las principales ingenierías dedicadas a la fabricación de bienes de equipo para la industria. Cras accumsan dignissim convallis. Curabitur aliquam efficitur diam ac pellentesque. Fusce ac leo est. <br>
                            <br>
